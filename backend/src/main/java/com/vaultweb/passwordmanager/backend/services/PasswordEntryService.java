...
public class PasswordEntryService {
    ...
    /**
     * Updates an existing PasswordEntry with new values provided in the updated object.
     * If the PasswordEntry with the specified ID does not exist, a NotFoundException is thrown.
     *
    ...
    /**
     * Deletes a PasswordEntry entity with the specified ID.
     * If the PasswordEntry does not exist, a NotFoundException is thrown.
     *
